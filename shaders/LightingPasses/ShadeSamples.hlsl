...
#endif
{
    ...
    RTXDI_Reservoir reservoir = RTXDI_LoadReservoir(g_Const.restirDI.reservoirBufferParams, GlobalIndex, g_Const.restirDI.bufferIndices.shadingInputBufferIndex);
